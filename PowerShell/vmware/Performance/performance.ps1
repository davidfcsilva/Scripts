...
# November 2015		Check if is already connected to vcenter
...
#-------------------------CHANGE THESE VALUES--------------------------------
$SMTPServer = "relay.ladbrokes.co.uk"
$vCenterServerName = "ukvcenterp01" 
$ToAddress = "david.silva@ladbrokes.co.uk"
#-----------------------------------------------------------------------------
